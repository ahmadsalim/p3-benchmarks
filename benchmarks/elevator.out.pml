...
active proctype controller() {
	...
	do	::	progress = true;
			...
			if	::	f.TTFull  && f.Exec;
					stop = (((person[0].in_elevator ; 1 : 0) + (person[1].in_elevator ; 1 : 0)) < 2 ; 
								(cabin_button[floor].pushed || floor_button[floor].pushed) && (floor == 3 || !(cabin_button[3].pushed || floor_button[3].pushed))
							:	(cabin_button[3].pushed || floor_button[3].pushed ;
										floor == 3
									: 	cabin_button[floor].pushed || (floor_button[floor].pushed && ((person[0].in_elevator ; 1 : 0) + (person[1].in_elevator ; 1 : 0)) < 2)));
				::	f.TTFull  && !f.Exec;
			...
			if 	::	atomic {
					...
					atomic {
						...
						if	::	f.Empty;
								if	::	(person[0].in_elevator ==  false && person[1].in_elevator ==  false);
										cabin_button[0].pushed = false; cabin_button[1].pushed = false; cabin_button[2].pushed = false; cabin_button[3].pushed = false;
									::	else;
									fi;
							::	else;
							fi;
			...
			atomic {
				...
				if	::	f.Exec;
						if	::	!set && (cabin_button[3].pushed || floor_button[3].pushed);
				...
				if	::	f.Park;
						if	::	!set && !( floor_button[0].pushed || cabin_button[0].pushed || floor_button[1].pushed || cabin_button[1].pushed || floor_button[2].pushed || cabin_button[2].pushed || floor_button[3].pushed || cabin_button[3].pushed );
